...
from robosuite.wrappers.custom_gym_wrapper import CustomGymWrapper
...
filename = f'teacher-student/result/{current_name[:-3]}'
cwd = os.getcwd()
...
if mode == 'test':
    num_envs = 16
    env = CustomGymWrapper(suite.make(
        env_name="LiftCustom", # try with other tasks like "Stack" and "Door"
